...
IMGUI_API void PlotLines(const char* label, const std::vector<float> &values, const char* overlay_text = NULL, float scale_min = FLT_MAX, float scale_max = FLT_MAX, ImVec2 graph_size = ImVec2(0, 0), int stride_in_floats = 1);
IMGUI_API void PlotHistogram(const char* label, const std::vector<float> &values, const char* overlay_text = NULL, float scale_min = FLT_MAX, float scale_max = FLT_MAX, ImVec2 graph_size = ImVec2(0, 0), int stride_in_floats = 1);
//Plot a Real function using a lambda
template<typename Lambda> IMGUI_API void PlotLines(const char* label, const Lambda &fun, const ImVec2 &domain, const ImVec2 &range = ImVec2(FLT_MAX, FLT_MAX), int values_count = 64,  const char* overlay_text = NULL, ImVec2 graph_size = ImVec2(0, 0))
{
	struct UserData
	{
...
//Plot a Real function using a lambda
template<typename Lambda> IMGUI_API void PlotHistogram(const char* label, const Lambda &fun, const ImVec2 &domain, const ImVec2 &range = ImVec2(FLT_MAX, FLT_MAX), int values_count = 16, const char* overlay_text = NULL, ImVec2 graph_size = ImVec2(0, 0))
{
	struct UserData
	{
		const Lambda *function;
